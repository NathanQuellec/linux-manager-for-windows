...
using Serilog;
using LinuxManager.Contracts.Models.Docker.Manifests;
...
public class DockerHelper
{
    ...
    [Obsolete("Linux Manager is not using docker client to pull image from docker hub. Instead fetching layers through HTTP calls")]
