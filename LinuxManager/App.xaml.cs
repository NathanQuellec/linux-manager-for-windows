...
public partial class App : Application
{
    ...
    private const string APP_FOLDER_NAME = "LinuxManager";
    ...
    public async Task InstallWslFromMicrosoftStoreDialog()
    {
        try
        {
            var dialog = new ContentDialog()
            {
                ...
                Content =
                    "Linux Manager cannot works properly, do you want to install WSL from the Microsoft Store ?",
    ...
    public static async void ShowIsProcessingDialog()
    {
        try
        {
            var dialog = new ContentDialog()
            {
                Title = "Linux Manager is currently creating a distribution",
